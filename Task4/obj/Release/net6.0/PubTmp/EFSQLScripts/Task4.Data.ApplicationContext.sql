...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230117154348_InitialDb')
BEGIN
    CREATE TABLE [Users] (
...
BEGIN
    ...
    VALUES (N'20230117154348_InitialDb', N'6.0.13');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230118123825_Identity')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230118123825_Identity', N'6.0.13');
END;
GO
